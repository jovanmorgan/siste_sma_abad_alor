    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-between mt-3">
                                                        ...
                                                        <button
                                                            onclick="openEditModal('<?php echo $id_berita; ?>', '<?php echo addslashes($nama); ?>', '<?php echo $waktu; ?>', '<?php echo addslashes($deskripsi); ?>', '<?php echo addslashes($gambar); ?>', '<?php echo addslashes($type); ?>');"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="tambahForms" method="POST" action="proses/berita/tambah.php"
                                        ...
                                        <div class="mb-3">
                                            <label for="type" class="form-label">Type Berita</label>
                                            <select id="type" name="type" class="form-select" required>
                                                <option value="">Pilih Type Berita</option>
            ...
            <script>
                ...
                function openEditModal(id_berita, nama, waktu, deskripsi, gambar_berita, type) {
                    // Set data to modal inputs
                    document.getElementById('id_berita').value = id_berita;
                    document.getElementById('edit-nama').value = nama;
                    document.getElementById('edit-waktu').value = waktu;
                    document.getElementById('edit-deskripsi').value = deskripsi;
                    document.getElementById('edit_type').value = type;

                    let gambar = "../../assets/img/berita/" + gambar_berita; // Perbaiki path jika perlu
                    let editModal = new bootstrap.Modal(document.getElementById('editModal'));

                    // Show preview of the existing image if available
                    if (gambar_berita !== '') { // Pastikan gambar ada sebelum menampilkan
