                    ...
                    <div class="mb-5">
                        ...
                        <div id="load_data">
                            <section class="section">
                                <h2 class="text-center fw-bold">Data Alumni</h2>
                                <p class="text-center mb-4">Pada bagian ini anda dapat melihat data Alumni</p>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                                ...
                                                <form method="GET" action="">
                                                    <div class="input-group mt-3">
                                                        <input type="text" class="form-control"
                                                            placeholder="Cari Alumni ..." name="search"
