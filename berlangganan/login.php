            ...
            <div class="form-container">
                ...
                <form id="login" action="../keamanan/proses_login" method="POST">
                    ...
                    <div class="password-container">
                        ...
                        <i class="fa fa-eye-slash show-password" style="color: #000; margin-bottom: 35px;"
                            aria-hidden="true" onclick="togglePasswordVisibility('login-password')"></i>
                    </div>
                        ...
                        Swal.fire({
                            ...
                            switch (responseArray[2].trim()) {
                                case "admin":
                                    ...
                                    break;
                                case "pendaftar":
                                    window.location.href = "../pengguna/pendaftar/";
                                    break;
                                default:
